      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8 relative">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
          ...
          <div className="md:col-span-8 flex flex-col justify-center pl-0 md:pl-12">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[0.98] text-zinc-950 mb-8 select-none">
              <span className="block mb-2">The live</span>
              <span className="block font-normal italic text-zinc-600 pl-4 md:pl-8">commerce</span>
              <span className="block">interface.</span>
            </h1>

            <p className="text-base text-zinc-500 leading-relaxed max-w-[42ch] mb-12 font-normal">
