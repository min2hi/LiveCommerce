      ...
      <div className="flex-1 flex items-center justify-center p-4 z-10">
        <div className="w-full max-w-[400px] bg-white border border-zinc-200/60 rounded-2xl p-8 shadow-[0_15px_40px_rgba(0,0,0,0.03)] flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-zinc-950">Login to LiveCommerce</h2>
            <p className="text-xs text-zinc-500">Access low-latency streams and shop live room products.</p>
          </div>
